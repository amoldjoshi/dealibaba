...
class AboutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create about" do
    assert_difference('About.count') do
      post abouts_url, params: { about: { answer: @about.answer, question: @about.question } }
    end
  ...
  test "should update about" do
    patch about_url(@about), params: { about: { answer: @about.answer, question: @about.question } }
