...
class DealersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dealer" do
    assert_difference('Dealer.count') do
      post dealers_url, params: { dealer: { dealerid: @dealer.dealerid, dealername: @dealer.dealername, dealertype: @dealer.dealertype, dealerurl: @dealer.dealerurl } }
    end
  ...
  test "should update dealer" do
    patch dealer_url(@dealer), params: { dealer: { dealerid: @dealer.dealerid, dealername: @dealer.dealername, dealertype: @dealer.dealertype, dealerurl: @dealer.dealerurl } }
