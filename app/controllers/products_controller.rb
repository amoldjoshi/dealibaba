class ProductsController < ApplicationController
  ...
  private
    ...
    def product_params
      params.require(:product).permit(:productid, :productname, :producturl, :producttype, :productdescription, :productresearch, :productprice, :productbutton, :productvisible, :picture, :productcategory, :animation)
    end
end
